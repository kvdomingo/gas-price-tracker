...
Python 3.10 introduced major improvements to type annotation syntax through PEP
604 (union types via `|`) and PEP 585 (generic types in standard collections).
These features eliminated the need for most `typing` module imports and made
type annotations more concise and readable.
...
**Note**: This is the standard way in Python 3.10. Python 3.12 introduces better
syntax (PEP 695).
