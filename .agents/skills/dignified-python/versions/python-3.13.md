...
This document captures type annotation guidance for Python 3.13. Python 3.13
implements PEP 649 (Deferred Evaluation of Annotations), fundamentally changing
how annotations are evaluated.
...
**Why**: Built-in types are more concise, don't require imports, and are the
modern Python standard (available since 3.10).
...
**Dignified Python prefers ABC** because it makes inheritance and intent
explicit.
...
**Note**: Prefer PEP 695 syntax for simple generics. TypeVar is still needed for
constraints/bounds.
...
**Note**: PEP 695 is cleaner - no imports needed, type parameter scope is local
to class.
