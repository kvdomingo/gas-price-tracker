...
Never generate documentation which simply restates the entity's name. Describe
**why, not just what**.
...
Calculated fields should include a brief description of the transformation and
its purpose.
